...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("              console.log(\"Estas ejecutando JQuery\");\n");
      out.write("            });\n");
      out.write("            \n");
      ...
      out.write("\n");
      out.write("                $.get('./UsuarioServlet?accion=login', {inputUsuario : USU, inputPassword : PWD}, function(response) {\n");
      out.write("                    if (response.mensaje == 'aceptado') {\n");
      out.write("                        //document.location = \"intranet.jsp\";\n");
      out.write("                        //document.location = \"../intranet.jsp?VenIncIntranet=bienvenida.jsp\";\n");
      out.write("                        //window.open('../usuarioLst.jsp', '_top');\n");
      out.write("                        console.log(\"Ingresaste\");\n");
      out.write("                    } else {\n");
      out.write("                        console.log(\"Hola: \" + response.mensaje);\n");
      out.write("                        alert(\"Estado: \" + response.mensaje);\n");
      out.write("                    }\n");
      out.write("                });\n");
      out.write("            }\n");
      out.write("\n");
